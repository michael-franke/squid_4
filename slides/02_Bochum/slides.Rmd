...
- pragmatic responders expect pragmatic speakersas before
- semantic responders expects <span style = "color:firebrick">literal speakers</span>
    - low-probability of a false utterance
    - any true utterance equally good
    
## results 

- correlation between predictions and observation (expluding redundant relative clauses):
